...
async function doGen(lead){
  ...
  try{const r=await ai('Cold email for: '+lead.company+' | '+lead.contact+', '+lead.title+' | '+lead.location+' | '+lead.employees+' employees | Pain: '+n.pain+'. Under 160 words. Specific opening about their business. Their core pain: no revenue visibility from digital spend. ONE case study with specific number. CTA: '+CALENDLY+'. Smart consultant tone. Format: Subject: [subject]\\n\\n[body]');S.emails[lead.id]=r;log('Email ready: '+lead.contact+' @ '+lead.company,'success');}
